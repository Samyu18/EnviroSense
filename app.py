...
<head>
    ...
    <style>
        ...
        #map { height: 40vh; min-height: 250px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); }
        .card { box-shadow: 0 2px 8px rgba(0,0,0,0.07); margin-bottom: 1rem; }
        .chart-container { height: 250px; }
        @media (max-width: 768px) {
            #map { height: 30vh; min-height: 180px; }
            .chart-container { height: 180px; }
        }
        .coords-label { font-size: 0.95rem; color: #555; margin-bottom: 0.5rem; text-align: center; }
        .nodata-msg { color: #b00; font-weight: 500; text-align: center; margin-top: 1rem; }
        .demo-label { color: #007bff; font-size: 0.95rem; font-weight: 500; text-align: center; margin-top: 0.5rem; }
    </style>
</head>
<body>
    <div class="container py-3">
        <h1 class="mb-3 text-center">EnviroSense</h1>
